...
class PaymentRequestEmail extends \WC_Email {
    /**
    ...
    public function __construct() {
        ...
        $this->title          = PAY_BY_LINK_EMAIL_HEADING; 
        $this->description    = PAY_BY_LINK_EMAIL_DESCRIPTION;
        $this->heading        = PAY_BY_LINK_EMAIL_HEADING;
        $this->subject        = 'Payment Request from ' . get_bloginfo( 'name' );
